...
| Tags | Env file |
| --- | --- |
| `base`, `prerequisite`, `docker`, `installation_cleanup`, `kesl_stop`, `kesl_start`, `kesl_enable`, `iptable`, `iptables`, `iptables_primary`, `iptables_zabbix`, `iptables_ipsets`, `iptables_save`, `iptable_accept`, `iptables_accept`, `iptable_block`, `iptables_block`, `mariadb_remove`, `openresty_remove`, `apache2_remove` | `20-base.env` |
