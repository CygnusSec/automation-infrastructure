...
| Tags | Env file |
| --- | --- |
| `base`, `prerequisite`, `docker`, `iptable`, `iptables`, `iptables_primary`, `iptables_zabbix`, `iptables_ipsets`, `iptables_save`, `iptable_block`, `iptables_block`, `mariadb_remove` | `20-base.env` |
