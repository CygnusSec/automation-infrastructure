...
ANSIBLE_ZABBIX_SERVER_OFFLINE_PACKAGES="${ANSIBLE_ZABBIX_SERVER_OFFLINE_PACKAGES:-zabbix-server-pgsql zabbix-frontend-php php8.3-pgsql zabbix-nginx-conf zabbix-sql-scripts zabbix-agent}"
